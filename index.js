...
var util = {
  ...
  isOperator : function(obj){
    var operators = ['$gt','$gte','$in','$lt','$lte','$ne','$nin','$or','$nor','$or','$not','$in','$nin','$exist','type','$mod','$regex','$text','$where','$all','$elemMatch','$size','$geoWithin','$geoIntersects','$near','$nearSphere','$geometry','$maxDistance','$center','$centerSphere','$box','$polygon','$uniqueDocs'];
    var operatorCount = 0;
